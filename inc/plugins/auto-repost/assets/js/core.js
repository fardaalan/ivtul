...
/**
 * AutoRepost Schedule Form
 */
AutoRepost.ScheduleForm = function()
{
 ...
 * AutoRepost Index
 */
AutoRepost.Index = function()
{
    $(document).ajaxComplete(function(event, xhr, settings) {
        var rx = new RegExp("(auto-repost\/[0-9]+(\/)?)$");
        if (rx.test(settings.url)) {
            AutoRepost.ScheduleForm();
        }
    });
}